...
(script demi final option -> easter egg pas fini !!!!!!!)
...
def draw_name_screen():
    ...
    player_img = pygame.image.load("chien.png").convert_alpha()  # .convert_alpha() pour la transparence
    player_img = pygame.transform.scale(player_img, (470, 392))
...
for event in pygame.event.get():
    ...
    # ===== OPTIONS =====
        ...
        if MENU_btn.clicked(event) or (
            event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE
        ):
            state = "menu"

        elif Skin_btn.clicked(event):
            state = "skin"

        elif Easteregg_btn.clicked(event):
            state = "easteregg"
    ...
    # ===== SKIN =====
        ...
        if R_btn.clicked(event):
            print("Skin Roux")

        elif M_btn.clicked(event):
            print("Skin Marron")

        elif Be_btn.clicked(event):
            print("Skin Beige")
